...
Ứng viên nên phản hồi lời mời phỏng vấn trong vòng 48 giờ.` },
  { id: 'payment', title: '6. Thanh toán & Hoàn tiền', content: `Các gói dịch vụ trả phí được thanh toán theo kỳ (tháng/năm). Giá đã bao gồm VAT.

Bạn có thể hủy gói dịch vụ bất cứ lúc nào. Gói sẽ vẫn hoạt động đến hết kỳ thanh toán hiện tại.

Hoàn tiền chỉ áp dụng trong vòng 7 ngày kể từ ngày thanh toán, với điều kiện chưa sử dụng các tính năng trả phí.` },
